...
LOCAL_SHARED_LIBRARIES += gl2es GLU SOIL android_app
LOCAL_SHARED_LIBRARIES += ovr #OpenGL VR

# thirdparty code
LOCAL_CFLAGS   += -I$(NDK_ROOT) -I$(LOCAL_PATH)/vrApi/include
LOCAL_SRC_FILES += $(addprefix ../,$(wildcard *.cpp))
LOCAL_SRC_FILES += $(addprefix ../,$(wildcard src/*.c))
...
include $(CLEAR_VARS)
LOCAL_MODULE   := main
LOCAL_SHARED_LIBRARIES := android_app application

# thirdparty code
LOCAL_CFLAGS   += -I$(NDK_ROOT)
...
# -- android_app ----------------------
include $(CLEAR_VARS)
LOCAL_MODULE   := android_app
LOCAL_SHARED_LIBRARIES := egl ovr
...
include $(CLEAR_VARS)
LOCAL_MODULE   := ovr
LOCAL_SHARED_LIBRARIES := vrapi # depends, but must not include: gl2es
